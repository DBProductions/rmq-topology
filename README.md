...
The project uses [Rollup](https://rollupjs.org/), [ESLint](https://eslint.org/),
[Prettier](https://prettier.io/) and [JSDoc](https://jsdoc.app/) with the
[clean-jsdoc-theme](https://ankdev.me/clean-jsdoc-theme/).\
[Vitest](https://vitest.dev/) and [Cypress](https://www.cypress.io/) run some
tests.
...
The specified runtime serves the tool at http://localhost:3000/ upon successful
startup.
