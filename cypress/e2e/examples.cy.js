describe('Test examples', () => {
  ...
  describe('Queue TTL example', () => {
    ...
    it('Export defintion', () => {
      ...
      cy.get('#ImExport').should(
        'have.value',
        '{"description":"","producers":[{"x":200,"y":130,"name":"Producer","publishes":{"0":{"exchange":"Exchange","routingKey":"Queue","message":{"headers":{},"body":{}}}}}],"consumers":[],"exchanges":[{"x":400,"y":130,"name":"Exchange","type":"direct","alternate":null}],"queues":[{"x":650,"y":130,"name":"Queue","type":"quorum","ttl":3000,"maxLength":""}],"bindings":[{"exchange":0,"queue":0,"routingKey":""}]}'
      )
    })
